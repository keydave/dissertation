...
public abstract class World extends AbstractAppState implements Closeable {
    ...
    protected final Map<TerrainLocation, TerrainChunk> worldTiles = new HashMap<>();
    protected final Map<TerrainLocation, TerrainChunk> worldTilesCache = new ConcurrentHashMap<>();
    ...
    /**
     * Set the time in which tiles are considered old enough to be removed from
     * the cache.
     *
    ...
    /**
     * Set the view distance in tiles for each direction according to the
     * initial view direction Vector3f.UNIT_Z.
     *
    ...
    private final Set<TerrainLocation> worldTilesQue = new HashSet<>();
    private final ConcurrentLinkedQueue<PendingChunk> newTiles = new ConcurrentLinkedQueue<>();
