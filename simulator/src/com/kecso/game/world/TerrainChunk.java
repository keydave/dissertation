...
public final class TerrainChunk extends TerrainQuad {
    ...
    public Node getStaticRigidObjectsNode() {
        return this.staticRigidObjects;
    }

    public void setStaticRigidObjectsNode(Node node) {
        this.staticRigidObjects = node;
    }

    public Node getStaticNonRigidObjectsNode() {
        return this.staticNonRigidObjects;
    }

    public void setStaticNonRigidObjectsNode(Node node) {
        this.staticNonRigidObjects = node;
    }
